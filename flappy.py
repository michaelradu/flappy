...
bird_downflap = pygame.transform.scale2x(pygame.image.load(
    './sprites/bluebird-downflap.png').convert_alpha())
bird_midflap = pygame.transform.scale2x(pygame.image.load(
    './sprites/bluebird-midflap.png').convert_alpha())
bird_upflap = pygame.transform.scale2x(pygame.image.load(
    './sprites/bluebird-upflap.png').convert_alpha())
...
#     'Flappy/sprites/bluebird-midflap.png').convert_alpha()
